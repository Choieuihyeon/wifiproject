package com.example.wifiproject8.dto;
...
public class WifiDto implements Comparable<WifiDto> {
    ...
    public WifiDto(String mgrNo, String wrdofc, String mainNm, String adres1, String adres2, String instlFloor, String instlTy, String instlMby, String svcSe, String cmcwr, String cnstcYear, String inoutDoor, String remars3, String x, String y, String workDttm, double distance) {
        this.mgrNo = mgrNo;
        this.wrdofc = wrdofc;
        this.mainNm = mainNm;
        this.adres1 = adres1;
